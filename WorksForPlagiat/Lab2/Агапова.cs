...
public class Program
{
    ...
    public bool Task_1_5(double r, double s)
    {
        ...
        // code here
        double di_r = Math.Sqrt((r * 4) / 3.14);
        double di_s = Math.Sqrt(s) * Math.Sqrt(2);
        if (di_s <= di_r)
        {
            answer = true;
        }
    ...
    public double Task_2_9(int n)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            double.TryParse(Console.ReadLine(), out sp);
            if (sp < answer)
            {
                answer = sp;
            }
    ...
    public double Task_3_3()
    {
        ...
        do
        {
            Console.WriteLine("Введите вес ученика, для окончания 0");
    ...
    public int Task_3_6()
    {
        ...
        do
        {
            ...
            Console.WriteLine("Введите y, для окончания 1000");
    ...
    public double Task_3_9()
    {
        ...
        do
        {
            Console.WriteLine("Введите результат, для окончания 0");
