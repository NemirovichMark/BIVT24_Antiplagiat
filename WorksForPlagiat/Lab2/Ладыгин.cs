...
public class Program
{
    ...
    public double Task_2_13(double A, double B, int type)
    {
        ...
        switch (type)
        {
            ...
            case 2:
                if (A < B * 2)
                    answer = A * Math.Sqrt(B * B - A * A / 4) / 2.0;
                else
                    answer = 0;
                break;
            default:
    ...
    public int Task_3_10()
    {
        ...
        double k;
        int cnt = 0;
        while (double.TryParse(Console.ReadLine(), out x) && double.TryParse(Console.ReadLine(), out y) && double.TryParse(Console.ReadLine(), out z) && double.TryParse(Console.ReadLine(), out k))
        {
            if (x != 2 && z != 2 && y != 2 && k != 2 && x != 3 && z != 3 && y != 3 && k != 3)
                answer++;
            cnt++;
